...
-- ============================================================================
-- WhatsApp bot backend (additive) -- see supabase/vml_whatsapp_bot_schema.sql
-- for the full commented version. Nothing here changes existing behavior;
-- these are new, currently-unused objects until a real WhatsApp Business
-- number is wired to gas/vml-whatsapp-bot.gs.
-- ============================================================================
